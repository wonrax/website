...
seriesTitle: "This one blog"
seriesDescription: "I've never had a blog site of my own. Like many software
engineers out there, I've always felt the need for one. And I finally did! This
series covers the design and implementation of my first blog site using Astro."
---
...
![Remote image with
featuretype=sm](https://res.cloudinary.com/dmdgv6qrg/image/upload/v1737782404/hhai.dev%20blog/authoring%20in%20markdown/DSCF2218_myzlaz.jpg "#width=2731;height=4096;featuretype=sm")
Remote image with `featuretype=sm`

![Remote image with
featuretype=md](https://res.cloudinary.com/dmdgv6qrg/image/upload/v1737782166/hhai.dev%20blog/authoring%20in%20markdown/DSCF8231_oaf24e.jpg "#width=2048;height=1365;featuretype=md")
Remote image with `featuretype=md`

![Remote image with
featuretype=lg](https://res.cloudinary.com/dmdgv6qrg/image/upload/v1737782228/hhai.dev%20blog/authoring%20in%20markdown/DSCF2194_s5m7rt.jpg "#width=4096;height=1743;featuretype=lg")
