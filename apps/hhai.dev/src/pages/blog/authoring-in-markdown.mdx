...
title: "Blog prelude"
description: "How I built this over-engineered blog."
...
![Remote image with
featuretype=sm](https://res.cloudinary.com/dmdgv6qrg/image/upload/v1697514558/hhai.dev%20blog/authoring%20in%20markdown/IMG_1203_asjkac.png
'#width=1920;height=816;featuretype=sm')
Remote image with `featuretype=sm`

![Remote image with
featuretype=lg](https://res.cloudinary.com/dmdgv6qrg/image/upload/v1697514531/hhai.dev%20blog/authoring%20in%20markdown/IMG_1219_uibxtp.png
'#width=2048;height=871;featuretype=lg')
