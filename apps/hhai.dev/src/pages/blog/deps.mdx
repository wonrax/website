...
Foremost, it's important to let us agree on what dependencies are.

> If I understand correctly how it works, when cargo goes to build dependencies, it automatically picks up bug fixes in transitive dependencies (semver)
...
unix utilities to perform their tasks, even programming in bash. https://www.youtube.com/watch?v=tc4ROCJYbm0
